...
def main():
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        config_fname = Path(sys.argv[1]).name
        shutil.copy(sys.argv[1], training_args.output_dir + f"/{config_fname}")  # back=up config file
    else:
    ...
    if data_args.dataset_name is not None:
        ...
        extension = "json" if "json" in extension else extension
        raw_datasets = load_dataset(
            extension,
