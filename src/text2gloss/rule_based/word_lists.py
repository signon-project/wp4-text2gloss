...
temporal_expressions = time_unit + time_point + season + day_of_week + month + moment_of_day + repeat_time
...
new_form_is_text = (
    comparison_with_separate_sign_with_e_keep_e + comparison_with_separate_sign + other_exeptions + quantifiers
)
####################################################################################################################
