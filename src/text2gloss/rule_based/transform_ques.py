...
from text2gloss.rule_based.reorder_glosses_helpers import find_clause_with_head
from text2gloss.rule_based.word_lists import question_words_with_noun
        ...
        if question_word.position < len(sentence) - 1:
            ...
            if question_word.lemma_ == "hoe" and next_word.text in ["laat", "vroeg"]:
                ...
                if index_head:
                    ...
                    clause_indices_new = [
                        index for index in clause_indices if index not in sentence_object.question_word_indices
                    ]
