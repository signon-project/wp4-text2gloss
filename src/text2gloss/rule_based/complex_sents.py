...
from complex_sents_helpers import split_based_on_conjunction_words, plural_with_apostrophe
...
def make_complex_gloss_sentence(complex_sentence, nlp):
    ...
    if isinstance(complex_sentence, str):
        ...
        for clause in clauses:
            ...
            glosses = [str(sentence_object.clause_list[index].new_form) for index in
                       sentence_object.sorted_glosses_indices if sentence_object.clause_list[index].new_form != '']
